import {
	...
	TELE2_SIM_NODE_TYPE,
	ALPITRONIC_ERROR_CODES_NODE_TYPE,
	ALFEN_ERROR_CODES_NODE_TYPE,
	ZEROVA_ERROR_CODES_NODE_TYPE,
	DRIIVZ_CSMS_NODE_TYPE,
	OCEAN_CSMS_NODE_TYPE,
	MONTA_CSMS_NODE_TYPE,
	EDRV_CSMS_NODE_TYPE,
	OCPP_16J_NODE_TYPE,
	NAYAX_LYNX_NODE_TYPE,
	PAYTER_CPS_NODE_TYPE,
	EDRV_API_NODE_TYPE,
	KORE_SUPERSIM_NODE_TYPE,
	EDRV_AIOPS_NODE_TYPE,
} from '@/constants';
					...
					sections: [
						{
							key: 'popular',
							title: i18n.baseText('nodeCreator.sectionNames.popular'),
							items: ['filter', 'if', 'removeDuplicates', 'splitOut'],
						},
					],
				},
			},
